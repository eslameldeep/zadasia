...
return [
    ...
    */
    'routes' => [
        ...
        'middleware' => env('CHATIFY_ROUTES_MIDDLEWARE', ['web','auth' , 'dashboard']),
        'namespace' => env('CHATIFY_ROUTES_NAMESPACE', 'App\Domain\Chat\Http\Controllers'),
    ],
    'api_routes' => [
        'prefix' => env('CHATIFY_API_ROUTES_PREFIX', 'dashboard/chat/chat/api'),
        'middleware' => env('CHATIFY_API_ROUTES_MIDDLEWARE', ['api']),
        'namespace' => env('CHATIFY_API_ROUTES_NAMESPACE', 'App\Domain\Chat\Http\Controllers\Api'),
    ],
