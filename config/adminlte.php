...
return [
    ...
    | https://github.com/jeroennoten/Laravel-AdminLTE/wiki/Basic-fontConfiguration
    |
     */
    ...
    'auth_logo' => [
        'enabled' => true,
        'img' => [
            'path' => '/dashboard-assets/images/icon-c.svg',
            'alt' => 'Auth Logo',
            'class' => '',
            'width' => 50,
            'height' => 50,
    ...
    */
    ...
    'classes_content' => '',
    'classes_sidebar' => 'sidebar-dark-indigo elevation-4 text-decoration-none',
    'classes_sidebar_nav' => 'nav-compact ',
    'classes_topnav' => ' navbar-dark p-1  text-sm',
    ...
    'use_route_url' => true,
    'dashboard-assets_url' => 'dashboard',
    'logout_url' => 'dashboard.logout',
    'login_url' => 'dashboard.login',
    'register_url' => '',
    // 'register_url' => 'register',
    'password_reset_url' => 'dashboard.password.request',
    ...
    'menu' => [
        ...
        [
            ...
            'route'        => 'dashboard.core.notification-menu.show',
            'topnav_right' => true,                   // Or "topnav => true" to place on the left (required).
            'dropdown_mode'   => true,                // Enables the dropdown mode (optional).
            'dropdown_flabel' => 'All notifications', // The label for the dropdown footer link (optional).
            'update_cfg'   => [
                'route'      => 'dashboard.core.notification-menu.update',
        ...
        'Sweetalert2' => [
            ...
            'files' => [
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => 'https://cdnjs.cloudflare.com/ajax/libs/limonte-sweetalert2/11.7.12/sweetalert2.min.js',
                ],
                [
                    'type' => 'css',
                    'asset' => true,
                    'location' => 'https://cdnjs.cloudflare.com/ajax/libs/limonte-sweetalert2/11.7.12/sweetalert2.min.css',
                ],
            ],
        ],
        'Pace' => [
        ...
        'flasher' => [
            ...
            'files' => [
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => 'dashboard-assets/js/flasher/flasher.min.js',
                ],
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => 'vendor/flasher/flasher-toastr.min.js',
                ],
            ],
        ],
        'Dropzone' => [
            ...
            'files' => [
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => 'dashboard-assets/js/dropzone/dropzone.min.js',
                ],
                [
                    'type' => 'css',
                    'asset' => true,
                    'location' => 'dashboard-assets/css/dropzone/dropzone.min.css',
                ],
            ],
        ],
