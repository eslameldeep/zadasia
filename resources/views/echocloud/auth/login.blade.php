          ...
          <div class="row">
            ...
            <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
              <div class="card card-plain mt-8">
                ...
                <div class="card-body">
                  <form role="form" method="POST" action="{{ route('echocloud.login') }}">
                    @csrf
                    @method('POST')
                    ...
                    <div class="mb-3">
                      <input type="password" class="form-control" name="password" placeholder="{{__('Password')}}" aria-label="Password" aria-describedby="password-addon">
                      @error('password')
                      <div class="form-text text-danger">  <strong>{{ $message }}</strong></div>
                      @enderror
                ...
                <div class="card-footer text-center pt-0 px-lg-2 px-1">
                  <p class="mb-4 text-sm mx-auto">
                    ...
                    {{__("or")}}
                    <a href="{{ route('echocloud.password.request') }}" class="text-info text-gradient font-weight-bold">{{__('forgot my password')}}</a>
                  </p>
                </div>
                @endif
